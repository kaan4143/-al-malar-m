  ...
  if (randomNumber == guessInput) {
    ...
    if (score > 1) {
      if (guessInput <= 0 || guessInput > 100) {
        backgroundP.innerHTML =
          "You made a mistake enter a number from 1 to 100";
        score--;
      } else {
        score--;
        guessInput > randomNumber
          ? (backgroundP.innerHTML = `Decrease <i class="fa-solid fa-arrow-trend-down fa-2x"> </i>`)
          : (backgroundP.innerHTML = `Increase <i class="fa-solid fa-arrow-trend-up fa-2x"></i>`);
      }
    } else {
...
async function welcome() {
  ...
  const newArr = [
    ...
    "System is loading...",
    "System loaded",
    'Lets Play <i class="fa-solid fa-face-grin-hearts"></i>',
...
async function close() {
  backgroundP.innerHTML =
    'Mihail Tal was here <i class="fa-regular fa-chess-knight fa-2x"></i>';
  let myPromise = new Promise(function (resolve) {
    setTimeout(function () {
      resolve("black");
    }, 1500);
